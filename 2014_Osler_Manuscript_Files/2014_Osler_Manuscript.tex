...
\bibitem[{\textit{Heaman and Grotzinger}(1992)}]{Heaman1992c}
Heaman, L.~M., and J.~P. Grotzinger (1992), 1.08 ga diabase sills in the
  ...
  \doi{10.1130/0091-7613(1992)020<0637:GDSITP>2.3.CO;2}.
...
\bibitem[{\textit{Torsvik et~al.}(2012)\textit{Torsvik, Van~der Voo, Preeden,
  Mac~Niocaill, Steinberger, Doubrovine, van Hinsbergen, Domeier, Gaina,
  Tohver, Meert, McCausland, and Cocks}}]{Torsvik2012a}
Torsvik, T.~H., R.~Van~der Voo, U.~Preeden, C.~Mac~Niocaill, B.~Steinberger,
  ...
  \textit{114}(3--4), 325--368, \doi{10.1016/j.earscirev.2012.06.007}.

\bibitem[{\textit{van Hinsbergen et~al.}(2011)\textit{van Hinsbergen,
  Steinberger, Doubrovine, and Gassm{\"o}ller}}]{Hinsbergen2011a}
van Hinsbergen, D. J.~J., B.~Steinberger, P.~V. Doubrovine, and
  ...
  \textit{116}(B6), \doi{10.1029/2010JB008051}.
...
\bibitem[{\textit{Weil et~al.}(2003)\textit{Weil, Geissman, Heizler, and {Van
  der Voo}}}]{Weil2003a}
Weil, A., J.~Geissman, M.~Heizler, and R.~{Van der Voo} (2003), Paleomagnetism
  ...
  \doi{10.1016/S0040-1951(03)00339-1}.
...
\caption{Monte Carlo simulations of rates implied by paleomagnetic and geochronologic data between the Osler Volcanic Group (OVG) and southwest limb of the upper North Shore Volcanic Group (NSVG). In (A), the white outlined points connected by a white line represent the mean paleolatitude (calculated for Duluth, MN) and age of the poles. The green and blue points are 5,000 of the 100,000 simulated pole pairs (OVG and NSVG respectively) used in the analysis and are connected by grey lines which represent the simulated rates. The histogram in (B) shows all 100,000 of the simulated rates that yield the labeled 5 percentile value of 16 cm/yr, median value of 24 cm/yr (also the value as calculated from the means) and  95 percentile value of 39 cm/yr.}
