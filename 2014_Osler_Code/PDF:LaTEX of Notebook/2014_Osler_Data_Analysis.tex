...
alpha95 = 3.51420656821 k= 50.020994936
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_16_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_20_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_20_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_20_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_22_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_22_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_22_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_24_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_24_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_24_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_29_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_29_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_29_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_33_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_38_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_38_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_38_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_42_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_42_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_42_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
A95 = 4.80394668574 k= 27.2260167637
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_45_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{longtable}
    ...
    \section{Comparision between data from Halls (1974) study and Simpson Island VGPs}
...
previously contribued MagIC database entries, site locations were
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_59_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_59_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_59_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
directions do not share a common mean at the 95\% confidence level.
    ...
    \subsubsection{Common mean tests between Halls (1974) data and the data from the upper
third of the Simpson Island stratigraphy}
...
Here are the results of the bootstrap test for a common mean
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_62_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_62_2.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_62_3.png}
    \end{center}
    { \hspace*{\fill} \\}
...
for a common mean.
    ...
    \subsubsection{Combining the data from the upper third of the Simpson Island
...
\texttt{\color{outcolor}Out[{\color{outcolor}23}]:}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_72_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
The rate of paleolatitudinal change implied by the poles pairs in cm/yr is:[ 23.99094426]
    ...
    \subsection{Sampling the age distribution}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_86_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
{\color{incolor}In [{\color{incolor}30}]:} \PY{n}{pole1\PYZus{}MCpoles}\PY{o}{=}\PY{p}{[}\PY{p}{]}
         ...
         \PY{k}{for} \PY{n}{n} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{samplesize}\PY{p}{)}\PY{p}{:}
             ...
             \PY{k}{for} \PY{n}{vgp} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{pole1\PYZus{}N}\PY{p}{)}\PY{p}{:}
                 ...
                 \PY{c}{\PYZsh{}this direction is centered at latitude of 90º and needs to be rotated}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_90_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{Verbatim}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_96_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    

    \subsection{Latitudinal change from beginning of early magmatic stage to main
magmatic stage}
...
9.8
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_102_1.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{2014_Osler_Data_Analysis_files/2014_Osler_Data_Analysis_102_2.png}
    \end{center}
    { \hspace*{\fill} \\}
...
pmagplotlib.py libraries of PmagPy version 2.206.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{o}{\PYZpc{}}\PY{k}{load} \PY{n}{IPmag}\PY{o}{.}\PY{n}{py}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{k+kn}{import} \PY{n+nn}{pmag}\PY{o}{,} \PY{n+nn}{pmagplotlib}
         \PY{k+kn}{import} \PY{n+nn}{pylab}
         ...
         \PY{l+s+sd}{    This function modifies the plotDI function of PmagPy for}
         \PY{l+s+sd}{    use in the IPython notebook environment}
